     ...
     <form className="flex flex-col gap-5" onSubmit={onSubmit}>
        ...
        <span className="flex justify-between items-center">
          <span className="text-sm ">
            Not Registered? <Link className="ml-[5px] text-blue-600 underline" to="/register">Register here</Link>
          </span>

          <button type="submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-300 ">Login</button>
        </span>
     </form>
   )
 }
