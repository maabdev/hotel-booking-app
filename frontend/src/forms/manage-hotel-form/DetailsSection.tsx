    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                ></input>
                {errors.name && <span className="text-red-500 text-sm font-bold">
                    {errors.name.message}
                </span>}
            </label>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                ></input>
                {errors.city && <span className="text-red-500 text-sm font-bold">
                    {errors.city.message}
                </span>}
            </label>
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                ></input>
                {errors.country && <span className="text-red-500 text-sm font-bold">
            ...
            <label  className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                ></input>
                {errors.pricePerNight && <span className="text-red-500 text-sm font-bold">
            ...
            <label className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                {errors.starRating && <span className="text-red-500 text-sm font-bold">
